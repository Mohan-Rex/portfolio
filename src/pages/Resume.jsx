      ...
      >
        ...
        >
          <div>
            ...
            <p style={{ marginTop: 10, fontSize: 15, color: "#ccc" }}>
              BCA Graduate | Full Stack Developer – MERN | React.js | Next.js | DevOps Enthusiast
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              📍 Whitefield, Bengaluru, Karnataka
            </p>
            <p style={{ margin: "4px 0", fontSize: 14, color: "#aaa" }}>
              ✉️ uniquemohan.19@gmail.com | 📞 +91 9513094209
            </p>
          </div>
        ...
        >
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: 0, lineHeight: 1.8 }}>
            <li>
              <strong>Bachelor of Computer Applications</strong> — Garden City University, Bengaluru  
              <br />
              <span style={{ color: "#aaa" }}>August 2020 – July 2023</span>
            </li>
          </ul>
        </motion.div>
